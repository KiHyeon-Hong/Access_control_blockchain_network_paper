...
app.get('/clear', (req, res) => {
  let chain = JSON.parse(fs.readFileSync(__dirname + '/AccessKeyBlockchain/files/Temp.json', 'utf8'));
  fs.writeFileSync(__dirname + '/AccessKeyBlockchain/files/Blockchain.json', JSON.stringify(chain), 'utf8');
  res.json('Success');
});
